    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        <div>
            ...
            <p className="text-gray-500 text-sm">Control de ingresos y cuentas pendientes</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
             ...
             <div className="relative">
                ...
                <select 
                    ...
                    className="pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 w-full sm:w-48"
                >
            ...
            <button 
                onClick={generatePDF}
                className="flex justify-center items-center gap-2 bg-slate-800 text-white px-4 py-2 rounded-lg hover:bg-slate-900 shadow-md transition-all"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center gap-4">
            ...
            <div>
                <p className="text-sm text-gray-500">Total Generado ({selectedMonth === 'all' ? 'Histórico' : selectedMonth})</p>
                <h3 className="text-2xl font-bold text-gray-900">$ {summary.globalPaid + summary.globalPending}</h3>
            </div>
        </div>
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center gap-4">
            ...
            <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900">$ {summary.globalPending}</h3>
            </div>
        </div>
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center gap-4">
            ...
            <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900">$ {summary.globalPaid}</h3>
            </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 h-80">
            <h3 className="font-bold text-gray-800 mb-4">Ingresos por Alumno (Top 10 en selección)</h3>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 h-80">
            <h3 className="font-bold text-gray-800 mb-4">{selectedMonth === 'all' ? 'Evolución Mensual' : 'Evolución Diaria'}</h3>
            {chartData.length > 0 ? (
                <ResponsiveContainer width="100%" height="100%">
